            ...
            images: [
              {
                ...
                width: 500,
                height: 334,
                alt: 'Minha foto de perfil em um fundo preto. Com um texto branco escrito: Página Inicial.'
              }
            ],
            type: 'website',
          ...
          <div className="card">
            <main>
              <p onClick={() => scrollTo(1)}>
                Olá me chamo Guilherme, {` ${props.age} `} tenho anos, seja
                muito bem-vindo ao meu site. Sou desenvolvedor Javascript, crio
                sites, WebApps e Apps para celular(Expo/React Native). Caso
                queira me conhecer mais acesse os links abaixo.
              </p>
            </main>
          </div>
          <nav>
